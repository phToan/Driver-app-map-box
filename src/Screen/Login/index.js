...
const Login = ({ navigation }) => {
  ...
  const { setKey, setAvatar, setId, setIsAuto } = useContext(AppContext);
  ...
  const onForgotPassword = () => {
    navigation.navigate(NameScreen.FORGOT_PASSWORD);
  };
        ...
        <View style={styles.body}>
          ...
          <View
            style={[
              ...
              {
                borderColor:
                  validatePhone(phoneNumber) === null ? "black" : "red",
              },
            ]}
          >
          ...
          <View
            style={[
              ...
              {
                borderColor:
                  validatePassword(password) === null ? "black" : "red",
              },
            ]}
          >
            <View style={styles.e_icon}>
